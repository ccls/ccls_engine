...
Gem::Specification.new do |s|
  ...
  s.files = [
    ...
    "lib/ccls_engine/active_record_extension/error.rb",
    "lib/ccls_engine/active_record_extension/errors.rb",
  ...
  s.test_files = [
    ...
    "test/unit/ccls/aliquot_sample_format_test.rb",
    "test/unit/ccls/aliquot_test.rb",
    "test/unit/ccls/analysis_test.rb",
    "test/unit/ccls/context_test.rb",
    "test/unit/ccls/core_extension_test.rb",
    "test/unit/ccls/data_source_test.rb",
    "test/unit/ccls/diagnosis_test.rb",
    "test/unit/ccls/document_type_test.rb",
    "test/unit/ccls/document_version_test.rb",
    "test/unit/ccls/enrollment_test.rb",
    "test/unit/ccls/gift_card_search_test.rb",
    ...
    "test/unit/ccls/ineligible_reason_test.rb",
    "test/unit/ccls/instrument_test.rb",
    "test/unit/ccls/instrument_type_test.rb",
    "test/unit/ccls/instrument_version_test.rb",
    "test/unit/ccls/interview_method_test.rb",
    "test/unit/ccls/interview_outcome_test.rb",
    ...
    "test/unit/ccls/package_test.rb",
    "test/unit/ccls/patient_test.rb",
    "test/unit/ccls/person_test.rb",
    "test/unit/ccls/phone_number_test.rb",
    "test/unit/ccls/phone_type_test.rb",
    "test/unit/ccls/pii_test.rb",
    "test/unit/ccls/project_outcome_test.rb",
