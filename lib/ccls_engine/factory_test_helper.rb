module Ccls::FactoryTestHelper
	...
	def create_home_exposure_with_subject(options={})
		...
		assert_difference('StudySubject.count',1) {
			study_subject    = Factory(:study_subject,options[:subject]||{})
		}
	...
	alias_method :create_study_subject, :create_subject
	...
	alias_method :create_study_subjects, :create_subjects
...
#puts "in create_subject_with_childid(#{childid})"
#		identifier = Factory(:identifier, 
#			:study_subject => subject,
#			:childid => childid )
...
#		Identifier.any_instance.unstub(:get_next_patid)
	...
	def create_subject_with_interview_outcome_on(date)
		create_hx_subject(:study_subject => {
			:homex_outcome_attributes => Factory.attributes_for(:homex_outcome,
